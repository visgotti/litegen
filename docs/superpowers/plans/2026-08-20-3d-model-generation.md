...
**Status:** ✅ DONE (2026-09-11, a468df4)
...
- [x] DONE 2026-09-11 **Param-mapping matrix:** annotate the `rig` row's Tripo3D cell
...
- [x] DONE 2026-09-11 **`apps/landing/scripts/derive-capabilities.mjs`:** update the top
...
- [x] DONE 2026-09-11 **`dashboard/src/components/generation-output.ts`:** correct the 404-retry
...
- [x] DONE 2026-09-11 **Transient-error tolerance in the trace-panel poll:** a single 5xx /
...
- [x] DONE 2026-09-11 **`GenerationOutput` video fallback:** `GenerationOutput.tsx:66` turns ANY
...
- [x] DONE 2026-09-11 **Playground Single Mode:** disable the model `<select>` while a
  generation is in flight. The exposure grew from a sub-second image request to
  a multi-second 3D poll (Task 13/14 review).
- [x] DONE 2026-09-11 **Gates:** `cd dashboard && npm test && npm run build && npm run lint`;
