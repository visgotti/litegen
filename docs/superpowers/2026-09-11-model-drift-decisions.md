...
|---|---|---|---|---|---|
| openai | `gpt-image-2.5-flare`, `gpt-image-2.5-sunburst` | GPT Image 2.5, released 2026-09-08; OpenAI's recommended model for new integrations | y (a catalog row; quality adds `xhigh`/`max`) | $8 in / $30 out per 1M image tokens | - [ ] add |
| kling | `kling-v2-5-turbo`, `kling-v2-6`, Image 2.1 | the 9/15 successors (section 1) | y | see §1 | - [ ] add |
| vidu | `viduq3-turbo`, `viduq3-pro`, `viduq2-pro-fast` | Q3 generation, plus a cheap Q2 Pro | y | $0.055/s; $0.045–0.12/s; $0.04 + $0.01/s | - [ ] add |
| pixverse | `v6`, `c1` | PixVerse's two recommended models (everything else is now "Legacy") | y | $0.35 / $0.40 for 5 s at 540p | - [ ] add |
| ideogram | `ideogram-v4` | Ideogram 4.0, the flagship | n (a small v4 branch: new path, `text_prompt`) | $0.03 / $0.06 / $0.10 | - [ ] add |
| minimax | `MiniMax-Hailuo-2.3-Fast` | the cheapest Hailuo image-to-video | y | $0.19 / $0.32 / $0.33 | - [ ] add |
| minimax | `MiniMax-H3`, `MiniMax-H3-Max` | MiniMax's current video models; Hailuo is now "legacy" | n (V2 API) | $0.05–0.13/s | - [ ] add later |
| recraft | `recraftv4_1_vector`, `recraftv4_1_pro_vector`, `recraftv2_vector` | V4.1 SVG output (we only carry V4.1 raster) | y (no `size`) | $0.08 / $0.30 / $0.044 | - [ ] add |
| bytedance | `seedance-1-0-pro-fast-251015`, `dreamina-seedance-2-0-mini-260615`, `seedream-4-5-251128`, `seedream-5-0-lite-260128` | the successors, plus Seedance 2.0 mini | y / partial (2.0 reference roles) | $1 per 1M tokens; $3.5 per 1M; $0.04; $0.035 per image | - [ ] add |
...
| bfl | `flux-2-max`, `flux-2-klein-9b` | FLUX.2 top tier and fast tier | y (same schema as flux-2-pro) | from $0.07/MP; from $0.015 | - [ ] add |
| stability | `sd3.5-medium` | SD 3.5 Medium on the sd3 route | y (`resolve_model` already routes it) | $0.035 | - [ ] add |
| replicate | `black-forest-labs/flux-1.1-pro` | replaces `replicate/flux-pro`: BFL retired FLUX.1 [pro] on its own API | n (one `resolve_model_version` line) | $0.04/image | - [ ] replace flux-pro |
| fal | `fal-ai/flux-2` (FLUX.2 [dev]) | half the price of `fal/flux-dev`; BFL hosts no [dev] | n (one `resolve_endpoint` line; unknown ids fall back to flux/dev) | $0.012/MP | - [ ] add |
...
|---|---|---|---|---|
| runway/gen4.5 | $0.50 | $0.60 per 5 s | docs.dev.runwayml.com/guides/pricing.md | - [ ] update |
| openai/gpt-image-2 | $0.04 | $0.053 (medium, 1024²) | developers.openai.com image guide | - [ ] update |
| minimax/image-01 | $0.01 | $0.0035 | platform.minimax.io pricing-paygo | - [ ] update |
| minimax/MiniMax-Hailuo-02, -2.3 | $0.43 / $0.49 | $0.28 (768P 6 s) | same | - [ ] update |
| google/gemini-3.1-flash-image | $0.02 | ~$0.067 (1K) | ai.google.dev/gemini-api/docs/pricing | - [ ] update |
| google/gemini-3.1-flash-lite-image | $0.01 | ~$0.034 | same | - [ ] update |
| google/gemini-3-pro-image | $0.05 | ~$0.134 | same | - [ ] update |
| kling (all carried) | $0.035–1.00 | $0.014–0.098/s | kling.ai pricing | moot after §1 |
| hunyuan/hunyuan-image | $0.04 | 0.5 CNY (≈$0.07) | cloud.tencent.com/document/product/1729/105925 | - [ ] update |
| recraft/recraftv4_1, _pro | $0.04 / $0.25 | $0.035 / $0.21 | recraft.ai/docs/api-reference/pricing.md | - [ ] update |
| vidu/viduq1 | $0.30 | $0.40 | platform.vidu.com/docs/pricing.md | - [ ] update |
| pixverse/v3.5 | $0.30 | $0.45 | docs.platform.pixverse.ai pricing | - [ ] update |
| bytedance/seedance-1-0-pro | $0.50 | $0.61 (1080p 5 s) | BytePlus 1544106 | - [ ] update |
| ideogram (character reference) | flat | $0.10 / $0.15 / $0.20 with a character ref | ideogram.ai/pricing | - [ ] variable pricing? |
| stability/sdxl | $0.002 | $0.009 (we undercharge 4.5×) | platform.stability.ai/pricing | - [ ] update |
| bfl/flux-2-pro | $0.05 | from $0.03/MP | docs.bfl.ml/quick_start/pricing.md | - [ ] update |
| fal/flux-pro | $0.05 | $0.04/MP | fal.ai/models/fal-ai/flux-pro/v1.1/llms.txt | - [ ] update |
| fal/sd35-medium | $0.025 | $0.02/MP | fal model page | - [ ] update |
| fal/video | $0.20 | $0.02/video (we charge 10×) | fal.ai/models/fal-ai/ltx-video/llms.txt | - [ ] update |
| replicate/sdxl | $0.012 | ~$0.0025/run ($0.005 covers our 100-step max) | replicate.com/stability-ai/stable-diffusion-xl | - [ ] update |
| replicate/video | $0.30 | ~$0.10/run | replicate.com/lucataco/animate-diff | - [ ] update |
