...
T = TypeVar("T", bound="PaginatedResponseWebhookDeliveryDataItem")


@_attrs_define
class PaginatedResponseWebhookDeliveryDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        paginated_response_webhook_delivery_data_item = cls(
            attempt_number=attempt_number,
            created_at=created_at,
            generation_id=generation_id,
            id=id,
        ...
        paginated_response_webhook_delivery_data_item.additional_properties = d
        return paginated_response_webhook_delivery_data_item
